  ...
  return (
    <div className="flex-grow p-8 bg-gray-100 overflow-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <button className="px-5 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 transition duration-300 ease-in-out flex items-center space-x-2">
          <svg
